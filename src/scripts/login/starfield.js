class StarField {
    ...
    draw(g) {
        ...
        for (var i = 0; i < this.stars.length; i++) {
            if (
                Math.abs(this.stars[i].sx - this.mX) <= 10 &&
                Math.abs(this.stars[i].sy - this.mY) <= 10 &&
                !mouseIsPressed &&
                this.objectLabelling &&
                !this.g
            ) {
                this.stars[i].label();
            }
        ...
        for (i = 0; i < this.planets.length; i++) {
            if (
                Math.abs(this.planets[i].sx - this.mX) <= 10 &&
                Math.abs(this.planets[i].sy - this.mY) <= 10 &&
                !mouseIsPressed &&
                this.objectLabelling &&
                !this.g
            ) {
...
class Planet {
    constructor() {
        ...
        this.name =
            this.gods[Math.floor(Math.random() * this.gods.length)] +
            " " +
            this.numerals[Math.floor(Math.random() * this.numerals.length)];
    }
